...
class FieldDataProcessor:
    """
    A class to process field data. This class provides methods to ingest data from an SQL database, rename columns, apply corrections, and merge weather station data to the main DataFrame.
    ...
    def rename_columns(self):
        ...
        # Temporarily rename one of the columns to void a naming conflict
    ...
    def apply_corrections(self, column_name='Crop_type', abs_column='Elevation'):
        ...
        Args:
            column_name (str, optional): The column to apply corrections to. Defaults to 'Crop_type'.
            abs_column (str, optional): The column on which to apply the absolute function. Defaults to 'Elevation'.
        """
    ...
    def weather_station_mapping(self):
        ...
        self.df = self.df.merge(weather_map_df, how='left', on='Field_ID')
    def process(self):
        """
